...
class Display1(object):
    def setupUi(self, mainWindow, data, data3,to_home):
        self.data3 = data3
        self.data =data
    ...
    def retranslateUi(self, mainWindow):
        ...
        for d,i in zip(self.data,range(len(self.data))):
            ...
            if d[3]=="CCJ":
                ...
                item.setText(_translate("mainWindow", "Click here"))
            item = QtWidgets.QTableWidgetItem()
...
class Display2(object):
    def setupUi(self, mainWindow, data,to_home):
        self.data = data
        mainWindow.setObjectName("mainWindow")
        mainWindow.resize(950, 440)
        self.centralwidget = QtWidgets.QWidget(mainWindow)
        self.centralwidget.setObjectName("centralwidget")
        self.tableWidget = QtWidgets.QTableWidget(self.centralwidget)
        self.tableWidget.setGeometry(QtCore.QRect(10, 10, 931, 381))
        self.tableWidget.setObjectName("tableWidget")
        self.tableWidget.setColumnCount(9)
        row_len=len(data)
        self.tableWidget.setRowCount(row_len)
        ...
        self.menubar.setObjectName("menubar")
        self.pushButton = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton.setGeometry(QtCore.QRect(10, 395, 89, 25))
        self.pushButton.setObjectName("pushButton")
        self.pushButton.clicked.connect(lambda:to_home())
        mainWindow.setMenuBar(self.menubar)
        self.statusbar = QtWidgets.QStatusBar(mainWindow)
    ...
    def retranslateUi(self, mainWindow):
        ...
        item.setText(_translate("mainWindow", "Trip_no"))
        item = self.tableWidget.horizontalHeaderItem(1)
        item.setText(_translate("mainWindow", "Ticket no."))
        item = self.tableWidget.horizontalHeaderItem(2)
        ...
        item = self.tableWidget.horizontalHeaderItem(8)
        item.setText(_translate("mainWindow", "Payment(INR)"))
        __sortingEnabled = self.tableWidget.isSortingEnabled()
        self.tableWidget.setSortingEnabled(False)
        for d,i in zip(self.data,range(len(self.data))):
            item = QtWidgets.QTableWidgetItem()
            ...
            self.tableWidget.setItem(i, 5, item)
            item = self.tableWidget.item(i, 5)
            item.setText(_translate("mainWindow", str(d[5])+str(d[6])))
            item = QtWidgets.QTableWidgetItem()
            self.tableWidget.setItem(i, 6, item)
            item = self.tableWidget.item(i, 6)
            item.setText(_translate("mainWindow", str(d[7])))
